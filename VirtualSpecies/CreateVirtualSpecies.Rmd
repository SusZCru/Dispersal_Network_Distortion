...
```{r Load input layers}
#Load as SpatRaster
Elevation <- rast(here('VirtualSpecies', 'inputData_forVS', 'Elev_nibbled_jenk.tif'))
MeanTemp <- rast(here('VirtualSpecies', 'inputData_forVS', 'BIO1_30s_now.tif'))
AnnualPrec <- rast(here('VirtualSpecies', 'inputData_forVS', 'BIO12_30s_now.tif'))
