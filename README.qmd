...
Download and use the metric using the 'Downlaod_the_Metric' file and README. In this file is also template data; a Zone for contiguous Borneo (only needed in Version 1), a baseline (LW_resi_lcc_50000.tif) and a comparison (future: LW_ssp585_y21_resi_lcc_50000.tif).
